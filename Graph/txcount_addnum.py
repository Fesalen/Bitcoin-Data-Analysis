...
#读取CSV文件数据
filename = 'C:/Users/wfw/Desktop/txcount_addnum_dayly.csv'
...
host.set_xlabel("时间")
host.set_ylabel("地址个数")
par.set_ylabel("交易数量")

p1, = host.plot(dates, addnums, label="每日新增地址个数")
p2, = par.plot(dates, prices, label="每日交易数量")
