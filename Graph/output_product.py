...
#读取CSV文件数据
filename = 'C:/Users/wfw/Desktop/output_price.csv'
...
host.set_xlabel("时间")
host.set_ylabel("比特币数量")
par.set_ylabel("美元")

p1, = host.plot(dates, addnums, label="每日平均交易比特币数")
p2, = par.plot(dates, prices, label="每日平均交易比特币价格")
