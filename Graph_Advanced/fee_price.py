...
#读取CSV文件数据
filename = 'C:/Users/wfw/Desktop/fee_day_price.csv'
...
plt.rcParams['font.sans-serif']=['SimHei']#中文字体展示
...
host.set_xlabel("时间")
host.set_ylabel("交易费/单位：比特币")
par.set_ylabel("比特币价格/单位：美元")

p1, = host.plot(dates, addnums, label="交易费")
...
plt.annotate("2016-07", xy=(dates[2166], 0.363074774235294), xytext=(-50, 50), textcoords='offset points',size=12,
             arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2"))

plt.annotate("2018-02", xy=(dates[2760], 0.638562648404908), xytext=(10, 25), textcoords='offset points',size=12,
             arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2"))
